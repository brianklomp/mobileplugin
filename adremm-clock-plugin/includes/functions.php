...
function adremm_clock_admin_enqueue($hook) {
    ...
    wp_enqueue_style('adremm-clock-admin-css', ADREMM_CLOCK_URL . 'admin/css/admin-style.css', array(), ADREMM_CLOCK_VERSION);

    // Enqueue custom admin JS
    wp_enqueue_script('adremm-clock-admin-js', ADREMM_CLOCK_URL . 'admin/js/admin-preview.js', array('jquery', 'wp-color-picker'), ADREMM_CLOCK_VERSION, true);
...
function adremm_clock_frontend_enqueue() {
    ...
    wp_enqueue_style('adremm-clock-public-css', ADREMM_CLOCK_URL . 'public/css/public-style.css', array(), ADREMM_CLOCK_VERSION);

    // Enqueue custom frontend JS
    wp_enqueue_script('adremm-clock-public-js', ADREMM_CLOCK_URL . 'public/js/public-clock.js', array('jquery'), ADREMM_CLOCK_VERSION, true);
